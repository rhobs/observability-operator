...
func TestWriteToDirSubstitutesOverlayFiles(t *testing.T) {
	...
	data, err := os.ReadFile(filepath.Join(dir, "overlays/generated/configmap-PLACEHOLDER_NAME-extra-PLACEHOLDER_NS.yaml"))
	if err != nil {
...
func newTestOverlay(t *testing.T) *Overlay {
	...
	if err := o.AddResource(&corev1.ConfigMap{
		ObjectMeta: metav1.ObjectMeta{Name: "PLACEHOLDER_NAME-extra", Namespace: "PLACEHOLDER_NS"},
