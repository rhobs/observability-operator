...
func (in *MonitoringConfig) DeepCopyInto(out *MonitoringConfig) {
	*out = *in
	...
	out.PersesDashboards = in.PersesDashboards
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PersesDashboardsReference) DeepCopyInto(out *PersesDashboardsReference) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PersesDashboardsReference.
func (in *PersesDashboardsReference) DeepCopy() *PersesDashboardsReference {
	if in == nil {
		return nil
	}
	out := new(PersesDashboardsReference)
	in.DeepCopyInto(out)
	return out
}
