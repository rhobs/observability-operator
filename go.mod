...
require (
	...
	github.com/perses/perses-operator v0.1.5
...
require (
	...
	github.com/perses/common v0.26.0 // indirect
	...
	github.com/rhobs/obo-prometheus-operator/pkg/client v0.80.1-rhobs1 // indirect
