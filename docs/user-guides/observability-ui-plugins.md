...
The plugin adds monitoring related UI features to the OpenShift web console, mostly related to AlertManagers and Prometheus. A number of new pages and features are enabled through this plugin. Including, but not limited to:
