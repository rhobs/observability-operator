...
- [logging.rhobs/v1alpha1](#loggingrhobsv1alpha1)
- [monitoring.rhobs/v1alpha1](#monitoringrhobsv1alpha1)

# logging.rhobs/v1alpha1
...
## LoggingStack
<sup><sup>[↩ Parent](#loggingrhobsv1alpha1 )</sup></sup>
...
<table>
    ...
    <tbody><tr>
      ...
      <td>true</td>
        ...
        <td><b><a href="#loggingstackspec">spec</a></b></td>
        <td>object</td>
        <td>
          LoggingStackSpec is the specification for desired Monitoring Stack<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td><b><a href="#loggingstackstatus">status</a></b></td>
        <td>object</td>
        <td>
          LoggingStackStatus defines the observed state of LoggingStack. It should always be reconstructable from the state of the cluster and/or outside world.<br/>
        </td>
        <td>false</td>
      </tr></tbody>
</table>
...
### LoggingStack.spec
<sup><sup>[↩ Parent](#loggingstack)</sup></sup>



LoggingStackSpec is the specification for desired Monitoring Stack
...
LoggingStackStatus defines the observed state of LoggingStack. It should always be reconstructable from the state of the cluster and/or outside world.
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#loggingstackstatusconditionsindex">conditions</a></b></td>
        <td>[]object</td>
        <td>
          Conditions provide status information about the LoggingStack<br/>
        </td>
        <td>true</td>
      </tr></tbody>
</table>
...
### LoggingStack.status.conditions[index]
<sup><sup>[↩ Parent](#loggingstackstatus)</sup></sup>
