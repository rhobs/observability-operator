...
var defaultImages = map[string]string{
	...
	"ui-troubleshooting-panel":   "quay.io/openshift-observability-ui/troubleshooting-panel-console-plugin:v0.4.2",
...
func main() {
	...
	op, err := operator.New(
		...
		operator.NewOperatorConfiguration(
			...
			operator.WithClusterObservability(operator.ObservabilityInstallerConfiguration{
